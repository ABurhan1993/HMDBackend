...
namespace CrmBackend.Migrations
{
    ...
    [Migration("20250503165829_UpdateNotificationUserIdToGuid")]
    partial class UpdateNotificationUserIdToGuid
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CrmBackend.Domain.Entities.Design", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("DesignCustomerReviewDate")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<int>("InquiryTaskId")
                        .HasColumnType("integer");
                    ...
                    b.Property<bool?>("IsTimerStarted")
                        .HasColumnType("boolean");
                    ...
                    b.Property<string>("TimerEndsOn")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("TimerStartedOn")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("TotalHoursConsumed")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("CrmBackend.Domain.Entities.InquiryTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CrmBackend.Domain.Entities.Measurement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool?>("IsMeasurementApproved")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("CrmBackend.Domain.Entities.NotificationMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CrmBackend.Domain.Entities.TaskFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CrmBackend.Domain.Entities.Design", b =>
                {
                    b.HasOne("CrmBackend.Domain.Entities.InquiryTask", "InquiryTask")
                        .WithOne()
                        .HasForeignKey("CrmBackend.Domain.Entities.Design", "InquiryTaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("InquiryTask");
                });
            ...
            modelBuilder.Entity("CrmBackend.Domain.Entities.InquiryTask", b =>
                {
                    b.HasOne("CrmBackend.Domain.Entities.User", "ApprovedByUser")
                        .WithMany()
                        .HasForeignKey("ApprovedByUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("CrmBackend.Domain.Entities.User", "AssignedToUser")
                        .WithMany()
                        .HasForeignKey("AssignedToUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("CrmBackend.Domain.Entities.Inquiry", "Inquiry")
                        .WithMany("InquiryTasks")
                        .HasForeignKey("InquiryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CrmBackend.Domain.Entities.Measurement", b =>
                {
                    b.HasOne("CrmBackend.Domain.Entities.InquiryTask", "InquiryTask")
                        .WithOne()
                        .HasForeignKey("CrmBackend.Domain.Entities.Measurement", "InquiryTaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
